        ...
        <div className="min-h-[80vh] flex items-center justify-center px-6">
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="text-center">
                    <h1 className="text-3xl font-extrabold indigo-gradient">Welcome back</h1>
                    <p className="text-white/40 mt-2 text-sm">Sign in to your ModelHive account</p>
                </div>
                ...
                <p className="text-center text-sm text-white/30">
                    ...
                    <Link href="/signup" className="text-indigo-400 hover:text-indigo-300 font-medium transition-colors">Sign up free</Link>
                </p>
            </div>
        </div>
    )
